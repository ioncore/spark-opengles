...
namespace DX9
{
	// d�claration du vertex descriptor sans coordonn�es de texture
	...
	// d�claration du vertex descriptor avec coordonn�es de textures 2d
	...
	// d�claration du vertex descriptor avec coordonn�es de textures 3d
	...
	class SPK_DX9_PREFIX DX9QuadRenderer :
	  public DX9Renderer,
	...
	protected :
		...
		virtual void DX9CallColorAndVertex(const Particle& particle) const;	// DX9 calls for color and position
		virtual void DX9CallTexture2DAtlas(const Particle& particle) const;	// DX9 calls for 2D atlastexturing
	...
	inline void DX9QuadRenderer::DX9CallColorAndVertex(const Particle& particle) const
	{
		...
		// TODO : �viter la duplication de l'information couleur
